151423920974662,-1.2366631610428571,-1.255375676455829,-1.2711585804933452,-1.283909514966324,-1.2935457851717718,-1.3000048961996649,-1.3032449582364227,-1.3032449582364227,-1.300004896199665,-1.2935457851717718,-1.2839095149663242,-1.2711585804933454,-1.255375676455829,-1.2366631610428573,-1.2151423920974662,-1.1909529400644652,-1.1642516828225453,-1.1352117882710357,-1.1040215912696278,-1.0708833722145386,-1.036012045172522,-0.9996337640806756,-0.9619844560513744,-0.9233082912944173,-0.8838560995795183,-0.8438837435090009,-0.803650459150638};
//bigest aperture in BKG detector, width=0.5 mm, height ~ 1.6 
//measured from Sam's paper, 
...
void DetectorConstruction::ConstructGrids() {
	...
	for (int i = 0; i < 32; i++) {
		new G4PVPlacement(0, G4ThreeVector(), frontGridContainerLog[i], "frontGridContainerOuter",
				frontGridContainerOuterLog[i], false, i, false);
		new G4PVPlacement(0, G4ThreeVector(), rearGridContainerLog[i], "rearGridContainerOuter",
	...
	for (int i = 0; i < 32; i++) {
		...
		new G4PVPlacement(G4Transform3D(rotMatrix, pos), frontGridContainerOuterLog[i],
				"frontGridWindow", worldLogical, false, i, false);
		...
		new G4PVPlacement(G4Transform3D(rotMatrix, pos), rearGridContainerOuterLog[i],
				"rearGridWindow", worldLogical, false, i, false);
	}
...
G4VPhysicalVolume *DetectorConstruction::Construct() {
	...
	blackHole= new G4Material("blackHole", density = 4e14* g / cm3, nelements = 1);
...
void DetectorConstruction::ConstructCFLAperture() {
	...
	new G4PVPlacement(0, G4ThreeVector(-10.45 * mm, 6.725 * mm, 0.2 * mm),
			CFLSmallHoleLog, "CFL_SMALL_TOP_LFET_Aperture", CFLLog, false,
			0, false);
	new G4PVPlacement(0, G4ThreeVector(-10.45 * mm, -6.725 * mm, 0.2 * mm),
...
void DetectorConstruction::ConstructBKGAperture() {
	...
	for (int j = 0; j < 80; j++) {
			vertexCoordsBKGBigAperture.push_back(G4TwoVector(BKG_BIGEST_APER_X[j] * mm, BKG_BIGEST_APER_Y[j] * mm));
		}
	...
	new G4PVPlacement(0, G4ThreeVector(-3.5 * mm, 3 * mm, 0.2 * mm),
			BKGBigBigRectApertureLog, "PIXEL_0_Aperture", BKGLog, false, 0, false);
	...
	new G4PVPlacement(0, G4ThreeVector(1.5 * mm, -3 * mm, 0.2 * mm),
			...
			false);
	new G4PVPlacement(0, G4ThreeVector(3.5 * mm, -3 * mm, 0.2 * mm),
			BKGBigBigRectApertureLog, "PIXEL_8_Aperture", BKGLog, false, 0, false);
